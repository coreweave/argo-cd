...
type MergeKeyedParamSet map[string]ParamSet
...
func (m *MergeGenerator) getParamSetsForAllGenerators(generators []argoprojiov1alpha1.ApplicationSetNestedGenerator, appSet *argoprojiov1alpha1.ApplicationSet, client client.Client) ([]ParamSets, error) {
...
func (m *MergeGenerator) GenerateParams(appSetGenerator *argoprojiov1alpha1.ApplicationSetGenerator, appSet *argoprojiov1alpha1.ApplicationSet, client client.Client) (ParamSets, error) {
	...
	mergedParamSets := make(ParamSets, len(baseParamSetsByMergeKey))
	i := 0
...
func getParamSetsByMergeKey(mergeKeys []string, paramSets ParamSets) (MergeKeyedParamSet, error) {
	if len(mergeKeys) < 1 {
	...
	paramSetsByMergeKey := make(MergeKeyedParamSet, len(paramSets))
	for _, paramSet := range paramSets {
		paramSetKey := make(ParamSet)
...
func (m *MergeGenerator) getParams(appSetBaseGenerator argoprojiov1alpha1.ApplicationSetNestedGenerator, appSet *argoprojiov1alpha1.ApplicationSet, client client.Client) (ParamSets, error) {
